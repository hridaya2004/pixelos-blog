...
<Callout className="max-w-4xl" type='warn' title={"WARNING"}>
Reports from users who have not followed these guidelines, such as **decrypted users**,
users who have **changed the kernel**, or users who have not performed a **clean flash**
when instructed to, may be ignored.
</Callout>
...
- Any relevant **logs** (by reading [this guide](./how-to-log)).

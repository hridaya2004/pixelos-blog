...
<Callout type="info" title="For newer builds">
...
<Callout type="info" title="For older builds">

If your build does not include the script, you will need to:

1. Download the `wipe-frp.sh` script from [here](https://raw.githubusercontent.com/PixelOS-AOSP/vendor_aosp/refs/heads/fifteen/prebuilt/common/bin/wipe-frp.sh).
...
<Callout type="success" title="You should be able to see similar output">
